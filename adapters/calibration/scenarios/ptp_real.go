...
func PTPRealScenario() *rca.Scenario {
	return &rca.Scenario{
		Name:        "ptp-real",
...
func ptpRealRCAs() []rca.GroundTruthRCA {
...
func ptpRealSymptoms() []rca.GroundTruthSymptom {
...
func ptpRealCases() []rca.GroundTruthCase {
...
func ptpRealWorkspace() rca.WorkspaceConfig {
