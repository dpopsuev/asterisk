...
func ResolveRPCases(fetcher orirp.EnvelopeFetcher, scenario *rca.Scenario) error {
...
func matchFailureItem(env *orirp.Envelope, c *rca.GroundTruthCase) *orirp.FailureItem {
	if c.RPItemID > 0 {
