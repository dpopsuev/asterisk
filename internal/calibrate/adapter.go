...
type StubAdapter struct {
	...
	// symptomIDMap maps ground truth symptom IDs to store-assigned IDs.
...
func (a *StubAdapter) buildRecall(c *GroundTruthCase) *orchestrate.RecallResult {
...
func (a *StubAdapter) buildTriage(c *GroundTruthCase) *orchestrate.TriageResult {
...
func (a *StubAdapter) buildResolve(c *GroundTruthCase) *orchestrate.ResolveResult {
...
func (a *StubAdapter) buildInvestigate(c *GroundTruthCase) *orchestrate.InvestigateArtifact {
...
func (a *StubAdapter) buildCorrelate(c *GroundTruthCase) *orchestrate.CorrelateResult {
...
func (a *StubAdapter) buildReview(c *GroundTruthCase) *orchestrate.ReviewDecision {
