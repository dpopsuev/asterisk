	...
	return []kami.ConceptGroup{
		...
		},
		{
			...
			Cards: []kami.ConceptCard{
				...
				{Name: "D2 — Devil's Advocate", Description: "Structured opposition: shadow persona argues the opposite conclusion with evidence."},
		...
		},
		{
			...
			Subtitle: "Four primary personas and four shadow counterparts, each with element identity",
			Cards: []kami.ConceptCard{
				{Name: "Herald (Fire)", Icon: "\U0001F525", Description: "Bold, fast, confident. First to declare a verdict. Shadow: overconfident, premature conclusions.", Color: "#ee0000"},
				{Name: "Seeker (Water)", Icon: "\U0001F30A", Description: "Methodical, thorough, evidence-first. Examines every log. Shadow: analysis paralysis, never concludes.", Color: "#37a3a3"},
				{Name: "Sentinel (Earth)", Icon: "\U0001F30D", Description: "Pragmatic, categorical, infrastructure-focused. Files and moves on. Shadow: oversimplifies, misses nuance.", Color: "#5e40be"},
				{Name: "Weaver (Air)", Icon: "\U0001F4A8", Description: "Creative, lateral thinker, cross-domain. Finds unexpected connections. Shadow: tangential, unfocused.", Color: "#f0ab00"},
				{Name: "Arbiter (Diamond)", Icon: "\U0001F48E", Description: "Skeptical, evidence-demanding, the final quality gate. Shadow: paralyzing perfectionism.", Color: "#0066cc"},
				{Name: "Catalyst (Lightning)", Icon: "\u26A1", Description: "Dispatcher, orchestrator, progress-focused. Keeps the pipeline moving. Shadow: sacrifices quality for speed."},
				{Name: "Shadow Personas", Description: "Each primary persona has a shadow — the adversarial version used in the Dialectic system to challenge conclusions."},
