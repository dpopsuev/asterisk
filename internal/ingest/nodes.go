...
type MatchSymptomsNode struct {
	Symptoms []calibrate.GroundTruthSymptom
}
...
func IngestNodeRegistry(fetcher LaunchFetcher, symptoms []calibrate.GroundTruthSymptom, project string, dedupIdx *DedupIndex, candidateDir string) framework.NodeRegistry {
